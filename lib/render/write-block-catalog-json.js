 ...
 * atomically to disk. Written at boot (index.js scanPlugins → catalog write);
 * consumed by the theme's composition renderer (block existence/gating,
 * collapse-chrome labels/icons) since the Phase 3 homepage cutover.
