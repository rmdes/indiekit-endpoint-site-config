...
export function designRouter(Indiekit, overrides = {}) {
  ...
  // Slug shape gate (D2 minimal): lowercase kebab, single segment. The FULL
  // double-guard (reserved-prefix + collision legs) lands in 6.5-T2; this is
  // only the routing-level shape filter so a malformed slug 404s instead of
  // minting a "page:<garbage>" surfaceId. Mirrors block-entry.js KEBAB_ID.
