...
export function designRouter(Indiekit, overrides = {}) {
  ...
  // SURFACE-SPECIFIC (homepage): the arrangement options ("stack" /
  // "sidebar-right") and the sidebar→main collapse are homepage's capability.
  // When a second arrangement-capable surface is registered (6.3+), gate this
  // route on a declared surface capability and source the valid arrangements
  // from the surface. Reachable only for homepage today (resolveSurface gates
  // every other surface to 404).
