 ...
 *   `sanitizeEntries`, `cap`). 6.4-T4: their last in-repo consumer
 *   (controllers/blog.js, the blog-tab POST) was removed when the blog tab was
 *   deleted — the post sidebar now lives in the postType composition surface.
 *   The helpers stay exported (covered by tests; reusable sanitizers).
 *
