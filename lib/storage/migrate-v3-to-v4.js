...
/**
 * The complete set of surface ids this migrator can compute (Phase 2).
 * Single home for this knowledge — consumers reporting on current seed state
 * (e.g. the migration-preview endpoint) import this rather than re-listing
 * the ids. Phase 6 surfaces (per-collection overrides, page:cv) extend here.
 */
export const MIGRATION_SURFACE_IDS = [
  "homepage",
  "collection:default",
  "posttype:default",
];
 ...
 * @returns {object | null}
 */
export function sidebarComposition(_id, kind, target, entries, newId) {
